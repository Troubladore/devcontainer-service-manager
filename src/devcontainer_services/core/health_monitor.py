...
from .service_pool import ServicePool, ServiceStatus
...
class HealthMonitor:
    ...
    def check_service_health(self, namespace: str, service_name: str) -> HealthCheckResult | None:
    ...
    def _check_service_health(
        self, service_pool: ServicePool, service_name: str
    ) -> HealthCheckResult:
        ...
        try:
            ...
            return HealthCheckResult(service_name=service_name, status=status, timestamp=timestamp)
    ...
    def get_health_summary(self) -> dict[str, dict[str, str]]:
        ...
        for namespace, service_pool in self.monitored_pools.items():
            ...
            for service_name, _service_info in service_pool.services.items():
                # Get latest status
