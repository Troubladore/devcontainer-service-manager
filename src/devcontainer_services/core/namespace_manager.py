...
class NamespaceManager:
    ...
    def get_current_namespace(self, project_name: str | None = None) -> str:
                ...
                if "devcontainer-service-manager.namespace" in labels:
                    ...
                    if ns_name not in namespaces:
                        namespaces[ns_name] = NamespaceInfo(
                            ...
                            port_range_start=int(
                                labels.get("devcontainer-service-manager.port_start", "8000")
                            ),
                            port_range_end=int(
                                labels.get("devcontainer-service-manager.port_end", "8099")
                            ),
                            active_services=[],
                        )
