...
class TestErrorHandling:
    ...
    @patch('devcontainer_services.core.service_pool.docker')
    def test_docker_connection_failure(self, mock_docker_module, service_pool, mock_docker,
    ...
    def test_invalid_template_handling(self, service_pool, temp_config_dir):
        ...
        invalid_config = {
            "template": "nonexistent-service:latest",
            "persistent": True
        }
...
class TestEdgeCases:
    ...
    def test_deep_dependency_chain(self, service_pool):
        ...
        for i in range(chain_length):
            ...
            if i > 0:
                ...
                assert dep_index < service_index, f"Dependency order violated for {expected_service}"
    ...
    def test_special_characters_in_names(self, namespace_manager):
        ...
        with patch.object(namespace_manager, '_detect_project_name', return_value=special_project):
            with patch.object(namespace_manager, '_get_current_branch', return_value=special_branch):
                namespace = namespace_manager.get_current_namespace()
...
class TestRecoveryScenarios:
    ...
    def test_recovery_from_partial_corruption(self, service_pool, mock_docker,
