...
echo
echo "6️⃣  Uninstalling DCM packages..."
...
if command_exists pipx; then
    ...
    if pipx uninstall devcontainer-service-manager 2>/dev/null; then
        ...
        echo "   ℹ️ Not installed via pipx or already uninstalled"
    fi
fi
...
if command_exists uv; then
    ...
    if uv pip uninstall devcontainer-service-manager --system 2>/dev/null; then
        ...
        echo "   ℹ️ Not installed via uv or already uninstalled"
    fi
fi
...
if command_exists pip; then
    ...
    if pip uninstall devcontainer-service-manager -y 2>/dev/null; then
        ...
        echo "   ℹ️ Not installed via pip or already uninstalled"
    fi
fi
...
if command_exists pip3; then
    ...
    if pip3 uninstall devcontainer-service-manager -y 2>/dev/null; then
        ...
        echo "   ℹ️ Not installed via pip3 or already uninstalled"
    fi
fi
